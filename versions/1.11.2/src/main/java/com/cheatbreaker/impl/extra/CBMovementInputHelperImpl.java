...
public class CBMovementInputHelperImpl extends MovementInputFromOptions implements CBMovementInputHelper {
    ...
    private static void updateToggleSprintString(MovementInputFromOptions movementInputFromOptions, EntityPlayerSP entityPlayerSP, GameSettings gameSettings) {
        String string = "";
