...
public class CBMovementInputHelperImpl extends MovementInputFromOptions implements CBMovementInputHelper {
    ...
    public static void lIIIIlIIllIIlIIlIIIlIIllI(Minecraft minecraft, MovementInputFromOptions movementInputFromOptions, EntityPlayerSP entityPlayerSP) {
        ...
        if (ToggleSprintModule.toggleSneak.<Boolean>value() && CheatBreaker.getInstance().getModuleManager().toggleSprint.isEnabled()) {
        ...
        CBMovementInputHelperImpl.updateToggleSprintString(movementInputFromOptions, entityPlayerSP, gameSettings);
    }
    ...
    private static void updateToggleSprintString(MovementInputFromOptions movementInputFromOptions,
                                                 EntityPlayerSP entityPlayerSP, GameSettings gameSettings) {
        String string = "";
