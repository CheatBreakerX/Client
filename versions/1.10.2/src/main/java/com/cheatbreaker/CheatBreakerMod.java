...
public class CheatBreakerMod {
    ...
    public static final MinecraftVersion MINECRAFT_VERSION = MinecraftVersion.v1_10_2;
    ...
    public static void CheatBreaker$preInitialize() {
        ...
        Ref.setBlockRegistry(Utils.iteratorToIterable(Utils.convertIterationType(Block.REGISTRY.iterator())));
