...
public class ModulePreviewContainer
    ...
    public void handleDrawElement(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawRoundedRect(this.x, this.y, this.x + this.width, this.y + this.height + 2, (double)8, CheatBreaker.getInstance().globalSettings.isDarkMode() ? -13619151 : -657930);
